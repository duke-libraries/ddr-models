    ...
    describe "#multires_image_file_paths" do
      ...
      context "structural metadata" do
        ...
        context "no structural objects with multi-res images" do
          before {
            Component.create(id: "test-5")
            Component.create(id: "test-6")
            Component.create(id: "test-7")
          }
          its(:multires_image_file_paths) { is_expected.to match([]) }
        end
        context "structural objects with multi-res images" do
          ...
          before {
            Component.create(id: "test-5", multires_image_file_path: "/path/file1.ptif")
            Component.create(id: "test-6")
            Component.create(id: "test-7", multires_image_file_path: "/path/file2.ptif")
          }
